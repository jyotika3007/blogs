    ...
    return (
        <div className="singlePost">
            ...
            <div className="singleBlog__container">
                ...
                <div className='singleBlog__banner'>
                ...
                <div className='singleBlog__row'>

                    <div className='singleBlog__info'>
                        <div className='singleBlog__socialIcons'>
                            <ul>
                                <li><FacebookIcon /></li>
                                <li><TwitterIcon /></li>
                                <li><GoogleIcon /></li>
                    ...
                    <div className="singleBlog__posts">
                    ...
                    <div className="singleBlog__adds">
                        <div className="singleBlog__mostRead">
                        ...
                        <div className="singleBlog__archieve">
                            <div className="singleBlog__postHeading">
                                <h2>Archieve</h2>
                            </div>
                            <ul>

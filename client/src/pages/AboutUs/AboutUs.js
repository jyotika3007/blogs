    ...
    return (
        <div className="category">
            ...
            <div className="category__container">
                ...
                <div className='category__row aboutUs__row'>

                    <div className="category__posts aboutUs_desc">
                        <img src="/images/post1.webp" className='aboutUs__img' />
